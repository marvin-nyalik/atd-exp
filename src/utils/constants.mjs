...
export const mock_products = [
  ...
  },
  {
    ...
    price: 250,
    description:
      'A stylish smartwatch with health and fitness tracking capabilities.',
  },
  {
    id: 5,
    name: 'Tablet',
    price: 500,
    description: 'A lightweight and versatile tablet for work and play.',
  },
  {
    id: 6,
    name: 'Camera',
  ...
  },
  {
    ...
    name: 'Monitor',
    price: 300,
    description: 'A 4K monitor with vibrant colors and sharp details.',
  },
  {
    id: 8,
    name: 'Keyboard',
    price: 100,
    description:
      'A mechanical keyboard with customizable keys and backlighting.',
  },
  {
    id: 9,
    name: 'Mouse',
    price: 50,
    description:
      'An ergonomic mouse with precision tracking and comfortable design.',
  },
  {
    id: 10,
    name: 'Printer',
    price: 200,
    description: 'A fast and reliable printer for all your printing needs.',
  },
]
